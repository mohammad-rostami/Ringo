...
public class FragmentReligion extends Fragment {
...
//    public RecyclerView.Adapter mRecyclerAdapter_Adapter;
    ...
    public static FragmentReligion newInstance(String param1, String param2) {
        FragmentReligion fragment = new FragmentReligion();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        new Async().execute("http://telegramgard.ir/rington/index.php/mobile/index/search/0/15", "1266","religion");
...
//            sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE, Uri.parse("file://" + Environment.getExternalStorageDirectory())));
    ...
    private class Async extends Webservice.PostClassCategory {
        @Override
        protected void onPreExecute() {
