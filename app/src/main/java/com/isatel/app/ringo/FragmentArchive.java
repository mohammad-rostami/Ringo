...
//    public RecyclerView.Adapter mRecyclerAdapter_Adapter;
    ...
    public static void memoryScan() {
        ...
        cursor = contentResolver.query(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, projection, MediaStore.Audio.Media.DATA + " like ? ", new String[]{"%media/audio/ringtones%"}, null);
...
//                arrayList.add(new Songs(currentId, currentTitle, currentArtist));
        ...
        try {
//            Toast.makeText(G.context, String.valueOf(arrayList.size()), Toast.LENGTH_SHORT).show();
            adapter_recycler.notifyDataSetChanged();
        } catch (Exception e) {
        }
