...
//    public RecyclerView.Adapter mRecyclerAdapter_Adapter;
    ...
    public static FragmentSms newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        new Async().execute("http://telegramgard.ir/rington/index.php/mobile/index/search/0/15", "1266", "sms");
