...
//    public RecyclerView.Adapter mRecyclerAdapter_Adapter;
    ...
    public static FragmentHappy newInstance(String param1, String param2) {
        FragmentHappy fragment = new FragmentHappy();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        new Async().execute("http://telegramgard.ir/rington/index.php/mobile/index/search/0/15", "1266","happy");
