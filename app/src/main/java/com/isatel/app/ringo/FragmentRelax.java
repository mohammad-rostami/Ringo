...
//    public RecyclerView.Adapter mRecyclerAdapter_Adapter;
    ...
    public FragmentRelax() {
        // Required empty public constructor
    }

    public static FragmentRelax newInstance(String param1, String param2) {
        FragmentRelax fragment = new FragmentRelax();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        new Async().execute("http://telegramgard.ir/rington/index.php/mobile/index/search/0/15", "1266","relax");
